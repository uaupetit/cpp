...
/*   Updated: 2024/02/22 18:56:44 by uaupetit         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	std::cout << "\n<-_-^-_-^-_-^-_-^-_-^-_-^-_-^->\n" << std::endl;
	std::cout << YELLOW << "Test 1 : check the types of animals, and make sound post standard constructors" << std::endl;
	std::cout << "Sound of i, a Cat : ";
	i->makeSound();
	std::cout << "Sound of j, a Dog : ";
	j->makeSound();
	std::cout << "Sound of Z, a WrongCat : ";
	z->makeSound();
	std::cout << "Sound of meta, an Animal : ";
	meta->makeSound();
	...
	Dog goodDoggy;
	Dog badDoggy;
	goodDoggy.getBrain()->_ideas[0] = "I WANT TO LICK YOUR FACE";
	badDoggy.getBrain()->_ideas[0] = "I WANT TO BITE YOUR FACEE";
	...
	std::cout << "badDoggy first idea = " << badDoggy.getBrain()->_ideas[0] << std::endl;
	std::cout << "goodDoggy first idea = " << goodDoggy.getBrain()->_ideas[0] << std::endl;
	...
	std::cout << "goodDoggy first idea = " <<  goodDoggy.getBrain()->_ideas[0] << std::endl;
	std::cout << "badDoggy first idea = " <<  badDoggy.getBrain()->_ideas[0] << std::endl;
	if (goodDoggy.getBrain()->_ideas[0] == badDoggy.getBrain()->_ideas[0] && badDoggy.getBrain() != goodDoggy.getBrain())
	...
	if (goodDoggy.getBrain()->_ideas[0] != badDoggy.getBrain()->_ideas[0])
