...
/*   Updated: 2024/01/09 17:17:51 by uaupetit         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    Bureaucrat::signForm (AForm& form)
{
    ...
    {
		form.beSigned(*this);
		std::cout << GREEN << this->_name << " signed " << form.getName() << std::endl;
	}
...
void    Bureaucrat::executeForm(AForm const& form)
{
	...
	{
		form.execute(*this);
		std::cout << GREEN << this->_name << " executed " << form.getName() << std::endl;
	}
	catch (std::exception &e)
	{
		std::cout << RED << this->_name << " could not execute " << form.getName() << " due to " << e.what() << std::endl;
	}
}
