...
/*   Updated: 2024/02/22 18:48:57 by uaupetit         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    std::cout << BLUE << "Constructor called" << std::endl;
...
{
    std::cout << BLUE << "Name constructor called" << std::endl;
    std::cout << GREEN << "Name: " << _Name << ", hit points: " << _HitPoints << ", energy points: " << _EnergyPoint << ", attack damage: " << _AttackDamage << std::endl;
    return;
}
...
void ClapTrap::attack(const std::string& target)
{
    ...
    {
        _EnergyPoint--;
        std::cout << YELLOW << _Name << " attacks " << target << ", causing " << _AttackDamage << " points of damage!" << std::endl; 
    }
    else if (_EnergyPoint <= 0 || _HitPoints <= 0)
        std::cout << RED << _Name << " has not enought energy or hit points to attack!" << std::endl;
}
